...
export const INITIAL_TENANT_LOCATION: TenantLocation = {
  ...
  emergencyContact: '+84 91 844 5566',
  contactPerson: 'Le Hoang Nam',
  capacity: 800,
  currentOccupancy: 534,
  createdAt: '2026-01-10T08:00:00+07:00',
  updatedAt: '2026-08-16T14:20:00+07:00',
  description: 'Corporate headquarters physical operating facility with automated barrier gates, dual ANPR cameras, and real-time edge processing.',
  operatingHours: {
    timezone: 'Asia/Ho_Chi_Minh',
    isOpen24_7: false,
    days: [
      { day: 'MONDAY', enabled: true, open: '07:00', close: '22:00' },
      { day: 'TUESDAY', enabled: true, open: '07:00', close: '22:00' },
      { day: 'WEDNESDAY', enabled: true, open: '07:00', close: '22:00' },
      { day: 'THURSDAY', enabled: true, open: '07:00', close: '22:00' },
      { day: 'FRIDAY', enabled: true, open: '07:00', close: '22:00' },
      { day: 'SATURDAY', enabled: true, open: '08:00', close: '18:00' },
      { day: 'SUNDAY', enabled: false, open: '08:00', close: '18:00' }
    ]
  }
};
